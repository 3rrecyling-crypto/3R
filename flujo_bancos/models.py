...
class ResumenMensual(models.Model):
    """Totales mensuales capturados manualmente (no partida a partida)."""
    periodo = models.CharField(max_length=7, unique=True, verbose_name="Periodo YYYY-MM")
    tc = models.DecimalField(max_digits=10, decimal_places=4, default=17.0000, verbose_name="Tipo de Cambio USD→MXN")

    ingresos_bancos_mxn   = models.DecimalField(max_digits=15, decimal_places=2, default=0)
    ingresos_bancos_usd   = models.DecimalField(max_digits=15, decimal_places=2, default=0)
    ingresos_efectivo_mxn = models.DecimalField(max_digits=15, decimal_places=2, default=0)
    ingresos_efectivo_usd = models.DecimalField(max_digits=15, decimal_places=2, default=0)

    gastos_bancos_mxn     = models.DecimalField(max_digits=15, decimal_places=2, default=0)
    gastos_bancos_usd     = models.DecimalField(max_digits=15, decimal_places=2, default=0)
    gastos_efectivo_mxn   = models.DecimalField(max_digits=15, decimal_places=2, default=0)
    gastos_efectivo_usd   = models.DecimalField(max_digits=15, decimal_places=2, default=0)

    venta_emitida_mxn     = models.DecimalField(max_digits=15, decimal_places=2, default=0)
    venta_emitida_usd     = models.DecimalField(max_digits=15, decimal_places=2, default=0)
    venta_operativa_mxn   = models.DecimalField(max_digits=15, decimal_places=2, default=0)
    venta_operativa_usd   = models.DecimalField(max_digits=15, decimal_places=2, default=0)

    actualizado = models.DateTimeField(auto_now=True)

    def __str__(self): return f"Resumen {self.periodo}"
